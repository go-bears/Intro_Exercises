...
class RobotTests(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual((0, 0), robot.coordinates) # robot.coordinates attribute should return (0,0)
        self.assertEqual(NORTH, robot.bearing) # robot.bearing attribute should return NORTH

    def test_setup(self):
        robot = Robot(SOUTH, -1, 1) # instaniate robot with passing in arguments
        self.assertEqual((-1, 1), robot.coordinates) # robot.coordinates attribute should return (-1,1)
        self.assertEqual(SOUTH, robot.bearing) # robot.bearing attribute should return SOUTH
